...
public class LabelAdapter extends RecyclerView.Adapter<LabelAdapter.RespoViewHolder> {
    ...
    public LabelAdapter(GithubLabel repList, Context context, int nums) {
    ...
    public void onBindViewHolder(@NonNull RespoViewHolder holder, final int position) {
        ...
        ItemLabel item = repList.getItems().get(position);

        holder.tvDescription.setText(item.getDescription());
        holder.tvOwner.setText(item.getName());
        holder.tvTitle.setText(String.valueOf(item.getScore()));
