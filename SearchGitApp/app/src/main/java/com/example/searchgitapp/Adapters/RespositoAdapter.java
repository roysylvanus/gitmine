...
public class RespositoAdapter extends RecyclerView.Adapter<RespositoAdapter.RespoViewHolder> {
    ...
    public RespositoAdapter(GithubRespo repList, Context context, int nums) {
    ...
    public void onBindViewHolder(@NonNull RespoViewHolder holder, final int position) {
        ...
        Item item = repList.getItems().get(position);

        holder.tvDescription.setText(item.getDescription());
        holder.tvOwner.setText(item.getFullName());
        holder.tvTitle.setText(item.getFullName());
